...
const bookAppointmentInput = z.object({
    ...
    startTime: z
        .string()
        .optional()
        .describe('Slot start time. Accepts 24h "17:00" or 12h "5:00 PM". Required unless slotId is supplied.'),
    slotId: z
        .string()
        .optional()
 ...
 */
let AppointmentsTools = class AppointmentsTools {
    appointments;
    constructor(appointments) {
        this.appointments = appointments;
    }
    async bookAppointment(input, ctx) {
...
__decorate([
    Tool({
        ...
        description: 'Book a consultation slot for a patient. Supply the doctorId, the date (YYYY-MM-DD) and either the slot start time (e.g. "17:00") or an exact slotId, plus the patient name and phone. Reserves the slot atomically and returns a bookingId — pass that bookingId to get-appointment to show the confirmation.',
...
], AppointmentsTools.prototype, "bookAppointment", null);
__decorate([
    Tool({
        name: 'get-appointment',
        title: 'Get appointment',
        description: 'Retrieve a booked appointment by bookingId and render the confirmation card: status, doctor photo and specialty, hospital and address, slot date/time, consultation mode, patient details and fee.',
    ...
    __metadata("design:paramtypes", [void 0, Object]),
    __metadata("design:returntype", Promise)
], AppointmentsTools.prototype, "getAppointment", null);
AppointmentsTools = __decorate([
    Injectable({ deps: [AppointmentsService] }),
    __metadata("design:paramtypes", [AppointmentsService])
], AppointmentsTools);
export { AppointmentsTools };
//# sourceMappingURL=appointments.tools.js.map